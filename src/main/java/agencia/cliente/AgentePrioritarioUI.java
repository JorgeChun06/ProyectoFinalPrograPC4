...
public class AgentePrioritarioUI extends JFrame {
    ...
    private void configurarVentanaPremium() {
        setTitle("TERMINAL PRIORITARIA - PC4 - Jorge Chun");
        setSize(900, 650); 
        ...
        JLabel lblTitulo = new JLabel("MODULO DE SERVICIO PRIORITARIO");
        ...
        txtAgente = crearCampoPro("Agente Asignado:", "Jorge Chun", false); 
    ...
    private void solicitarTicketConcurrente() {
        if (clientesEnCola == 0) {
            JOptionPane.showMessageDialog(this, "La cola esta vacia. No hay pasajeros para llamar.", "AVISO", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        Thread hilo = new Thread(() -> {
            try {
                ...
                out.writeObject("SOLICITAR_PRIORITARIO");
                out.flush();
                ...
                if (respuesta instanceof TicketViaje) {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        ...
                        actualizarEstadoUI("EN ATENCION PRIORITARIO", AZUL_NEON, true);
        ...
        radarCola = new Timer(3000, e -> {
            new Thread(() -> {
                try {
                    ...
                    out.flush();
                    ObjectInputStream in = new ObjectInputStream(s.getInputStream());
                    out.writeObject("TAMANO_COLA_PRIORITARIA");
                    out.flush();
                    ...
                    SwingUtilities.invokeLater(() -> {
                        ...
                        if (cantidad > 0) {
                            lblEnCola.setText("COLA: " + cantidad + " CLIENTE PRIORITARIO");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new AgentePrioritarioUI().setVisible(true));
    }
}